  ...
  return (
    ...
    >
            ...
            {benefits.map((b) => (
              ...
              >
                <div className="h-8 w-8 rounded-lg flex items-center justify-center mb-2.5" style={{ background: "rgba(13,148,136,0.08)" }}>
                  <b.icon className="h-4 w-4" style={{ color: "#0D9488" }} />
                </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 lg:pl-10 lg:pr-16">
        <motion.div initial={{ opacity: 0, x: 30, scale: 0.97 }} animate={{ opacity: 1, x: 0, scale: 1 }} transition={{ duration: 0.7, delay: 0.2, ease }} className="w-full max-w-[440px]">
